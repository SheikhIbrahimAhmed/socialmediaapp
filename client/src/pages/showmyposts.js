...
const ShowMyPosts = () => {
    ...
    useEffect(() => {
        const fetchMyPosts = async () => {
            try {
                ...
                const response = await axios.get(`http://localhost:5000/api/post/get-single-post?userId=${userId}`);
    ...
    return (
        <div className="container mx-auto p-4">
            <h1 className="text-4xl font-semibold text-center mb-6 text-gray-800">My Posts</h1>
            {loading ? (
